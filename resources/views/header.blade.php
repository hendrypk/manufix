<header id="header" class="header d-flex align-items-center fixed-top">
    ...
    <div class="container position-relative d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex align-itens-center justify-content-end">
            <a class="cta-btn" href="#about" title="Free Trial">Free Trial</a>
            <a class="cta-btn" href="#about" title="Contact Us">Contact Us</a>
            <button class="user-btn" title="login"><i class="fa-solid fa-circle-user"></i></button>
        </div>
    </div>
</header>
